...
export class ResConfig {
    ...
    public static  skillBook_list:SkillBookConfig[] = [////////////技能书
        {name:'烈火',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'RagingFire',explain:'烈火',arms_limit:"knife"},
        {name:'狂风斩',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'FierceWind',explain:'狂风斩',arms_limit:"knife",effect_config:{name:'狂风斩',attack_l:3,range_l:3,type:'attack'}},
        {name:'逐日剑法',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'PursueSun',explain:'逐日剑法',arms_limit:"knife",effect_config:{name:'逐日剑法',attack_l:4,range_l:4,type:'attack'}},
        {name:'冰咆哮',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'Hailstorm',explain:'冰咆哮',arms_limit:"staff",effect_config:{name:'冰咆哮',attack_l:13,range_l:5,type:'attack'}},
        {name:'流星火雨',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'MeteorSwarm',explain:'流星火雨',arms_limit:'staff',effect_config:{name:'流星火雨',attack_l:16,range_l:6,type:'attack'}},
        {name:'灭天火',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'SkyFire',explain:'灭天火',arms_limit:'staff',effect_config:{name:'灭天火',attack_l:19,range_l:1,type:'attack'}},
        {name:'噬血术',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'Hemophagy',explain:'噬血术',arms_limit:'stick',effect_config:{name:'噬血术',attack_l:19,range_l:1,type:'attack'}},
        {name:'治愈术',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'Cure',explain:'治愈术',arms_limit:'stick',effect_config:{name:'治愈术',attack_l:1,range_l:1,type:'assist',continue_time:100,add_continue_blood:20,add_continue_magic:0}},
        {name:'灵引符',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'CallPet',explain:'召唤一只骷髅为你战斗。',arms_limit:'stick',pet_config:{name:'骷髅',blood:100,magic:100,blood_limit:100,magic_limit:100,physics_attack:100,magic_attack:0,physics_defense:50,magic_defense:20,life_time:100,cd_time:1}},
        {name:'化魂符',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'CallPet',explain:'召唤一只麒麟为你战斗。',arms_limit:'stick',pet_config:{name:'麒麟',blood:100,magic:100,blood_limit:100,magic_limit:100,physics_attack:100,magic_attack:0,physics_defense:50,magic_defense:20,life_time:100,cd_time:1}},
        {name:'飞仙符',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'CallPet',explain:'召唤一只哮天犬为你战斗。',arms_limit:'stick',pet_config:{name:'哮天犬',blood:100,magic:100,blood_limit:100,magic_limit:100,physics_attack:100,magic_attack:0,physics_defense:50,magic_defense:20,life_time:100,cd_time:1}},
    ]
