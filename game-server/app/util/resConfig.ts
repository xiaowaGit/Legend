...
export class ResConfig {
    ...
    public static  skillBook_list:SkillBookConfig[] = [////////////技能书
        ...
        {name:'治愈术',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'Cure',explain:'治愈术',arms_limit:'stick',effect_config:{name:'',attack_l:1,range_l:1,type:'assist',continue_time:100,add_continue_blood:20,add_continue_magic:0}},
