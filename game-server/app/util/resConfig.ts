...
export class ResConfig {
    ...
    public static  skillBook_list:SkillBookConfig[] = [////////////技能书
        ...
        {name:'狂风斩',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'FierceWind',explain:'狂风斩',arms_limit:"knife"},
        {name:'逐日剑法',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'PursueSun',explain:'逐日剑法',arms_limit:"knife"},
        {name:'冰咆哮',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'Hailstorm',explain:'冰咆哮',arms_limit:"staff",effect_config:{name:'冰咆哮',attack_l:13,type:'attack'}},
        {name:'流星火雨',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'MeteorSwarm',explain:'流星火雨',arms_limit:'staff',effect_config:{name:'流星火雨',attack_l:16,type:'attack'}},
        {name:'灭天火',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'SkyFire',explain:'灭天火',arms_limit:'staff',effect_config:{name:'灭天火',attack_l:19,type:'attack'}},
        {name:'噬血术',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'Hemophagy',explain:'噬血术',arms_limit:'stick',effect_config:{name:'噬血术',attack_l:19,type:'attack'}},
        {name:'治愈术',blood:0,magic:0,consume_magic:0,cd:0,effect_name:'Cure',explain:'治愈术',arms_limit:'stick',effect_config:{name:'',attack_l:1,type:'assist',continue_time:100,add_continue_blood:20,add_continue_magic:0}},
